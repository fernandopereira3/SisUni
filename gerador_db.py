...
nomes = [
    ...
    "GABRIEL", "RAFAEL", "MATEUS", "FELIPE", "BRUNO", "GUSTAVO", "DANIEL", "RODRIGO", "LEANDRO", "FERNANDO",
    "RICARDO", "SAMUEL", "ANDRÉ", "THIAGO", "ALEXANDRE", "EDUARDO", "DIEGO", "LEONARDO", "JORGE", "ROBERTO",
    "SÉRGIO", "AUGUSTO", "VINÍCIUS", "CAIO", "MURILO", "FÁBIO", "IGOR", "GUILHERME", "RENATO", "WALLACE",
    "JEFFERSON", "WELLINGTON", "CRISTIANO", "ALAN", "EMERSON", "RAUL", "WESLEY", "VICTOR", "EVERTON", "CÍCERO", 
    "MARIA", "ANA", "FRANCISCA", "ANTÔNIA", "ADRIANA", "JULIANA", "MARCIA", "FERNANDA", "PATRÍCIA", "ALINE",
    "SANDRA", "CAMILA", "AMANDA", "BRUNA", "JÉSSICA", "LETÍCIA", "FABIANA", "DANIELA", "GABRIELA", "ALESSANDRA",
    "SIMONE", "ELAINE", "CARLA", "LUCIANA", "TATIANE", "RAQUEL", "DÉBORA", "BIANCA", "VANESSA", "LARISSA",
    "MICHELE", "CLÁUDIA", "RENATA", "SHEILA", "SÔNIA", "RITA", "ROSA", "CÍNTIA", "VIVIANE", "REGINA",
    "CRISTIANE", "MÔNICA", "ELISÂNGELA", "KELLY", "TÂNIA", "NATÁLIA", "PAULA", "SOLANGE", "VERÔNICA", "ISABEL"
]

sobrenomes = [
    "SILVA", "SANTOS", "OLIVEIRA", "SOUZA", "RODRIGUES", "FERREIRA", "ALVES", "PEREIRA", "LIMA", "GOMES",
    "RIBEIRO", "CARVALHO", "ALMEIDA", "LOPES", "SOARES", "FERNANDES", "VIEIRA", "BARBOSA", "ROCHA", "DIAS",
    "MONTEIRO", "MENDES", "CAMPOS", "COSTA", "MARTINS", "ARAUJO", "NASCIMENTO", "CORREIA", "TEIXEIRA", "REIS",
    "MACHADO", "CARDOSO", "NUNES", "CASTRO", "FREITAS", "MOREIRA", "MIRANDA", "PINTO", "CAVALCANTI", "AZEVEDO",
    "MORAIS", "CUNHA", "RAMOS", "MOURA", "FONSECA", "XAVIER", "COELHO", "MEDEIROS", "TORRES", "ANDRADE",
    "MELO", "BARROS", "PAIVA", "NOGUEIRA", "MAGALHAES", "TAVARES", "BEZERRA", "FARIAS", "BAPTISTA", "MARQUES"
]

procedencias = [
    "CPP VALPARAISO", "CPP SOROCABA", "CPP PRESIDENTE VENCESLAU", "CPP AMERICANA", "CPP ARARAQUARA",
    "CPP BAURU", "CPP CAMPINAS", "CPP FRANCA", "CPP GUARULHOS", "CPP JUNDIAI", "CPP LIMEIRA",
    "CPP MARILIA", "CPP MOGI DAS CRUZES", "CPP OSASCO", "CPP PIRACICABA", "CPP RIBEIRAO PRETO",
    "CPP SANTO ANDRE", "CPP SAO BERNARDO", "CPP SAO CAETANO", "CPP SAO JOSE DOS CAMPOS",
    "CPP SAO VICENTE", "CPP TAUBATE", "CPP DIADEMA", "CPP SUZANO", "CPP CARAPICUIBA"
]

pavilhoes = ["1A", "1B", "1C", "2A", "2B", "2C", "3A", "3B", "3C", "4A", "4B", "4C", "5A", "5B", "5C"]
...
def generate_nome():
    ...
    if random.random() > 0.3:
        nome_do_meio = random.choice(nomes) if random.random() > 0.5 else random.choice(sobrenomes)
...
def main():
    ...
    print(f"\nEstatísticas:")
    print(f"- Arquivo salvo: db_modelo.json")
